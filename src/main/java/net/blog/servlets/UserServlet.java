  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    switch (param) {
      case "signup":
        ...
        if (con != null) {
          try {
            ...
            String query =
                "insert into weibo.user(user_name, user_pwd, user_email, user_tel, user_age) "
                    + "values ('"
                    + name
                    + "', '"
                    + pwd
      ...
      case "linkFriend":
        ...
        String f2 = request.getParameter("f2name");
        ...
        if (con1 != null) {
          try {
            ...
            String check1 =
                "select * from weibo.friend where f1_name = '"
                    + f1
                    + "' and f2_name = '"
                    + f2
                    + "';";
            String query1 =
                "insert into weibo.friend(f1_name, f2_name, friend_type) "
                    + "values ('"
                    + f1
                    + "', '"
                    + f2
      ...
      case "delFriend":
        ...
        String f21 = request.getParameter("f2name");
        ...
        if (con11 != null && f11 != null && f21 != null) {
          try {
            ...
            String query1 =
                "delete from weibo.friend where f1_name = '"
                    + f11
                    + "' and f2_name = '"
                    + f21
                    + "';";
        ...
        break;
      case "visitFriend":
        String visit = request.getParameter("f2name");
