  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    switch (param) {
          ...
          try {
            ...
            try {
              ...
              if (rs1.next() && rs1.getString(1) != null) {
                ...
                wid++;
                query =
                    "insert into weibo.weibo(weibo_id, user_name, weibo_text, "
      ...
      case "addComm":
        ...
        String weiboid = request.getParameter("weiboc_id");
          ...
          try {
            ...
            try {
              ...
              if (rs11.next() && rs11.getString(1) != null) {
                ...
                wid11++;
                query =
                    "insert into weibo.comm(comm_id, user_name, weibo_id, "
                        + "comm_text, comm_date) "
                        + "values ("
                        + wid11
                        + ", '"
      ...
      case "addCommf":
        ...
        String weiboid1 = request.getParameter("weiboc_id");
